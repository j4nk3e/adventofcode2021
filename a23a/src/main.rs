...
fn main() {
    ...
    rooms.push(Room {
        ...
        dest: Some('A'),
        capacity: 2,
        space: RefCell::new([bottom[3], top[3]].to_vec()),
    });
    rooms.push(Room::o(3));
    rooms.push(Room {
        i: 4,
        dest: Some('B'),
        capacity: 2,
        space: RefCell::new([bottom[5], top[5]].to_vec()),
    });
    rooms.push(Room::o(5));
    rooms.push(Room {
        i: 6,
        dest: Some('C'),
        capacity: 2,
        space: RefCell::new([bottom[7], top[7]].to_vec()),
    });
    rooms.push(Room::o(7));
    rooms.push(Room {
        i: 8,
        dest: Some('D'),
        capacity: 2,
        space: RefCell::new([bottom[9], top[9]].to_vec()),
    });
    rooms.push(Room::o(9));
